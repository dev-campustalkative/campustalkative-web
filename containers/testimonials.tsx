    ...
    <div className="py-8 my-12 sm:my-6">
      <Container>
        <div className="flex flex-col justify-center items-center">
          <div
            data-aos="flip-down"
            className="bg-ct-primary-1000 p-2 text-center my-8 sm:my-2"
          >
          ...
          <div className="my-4 sm:my-0">
            <h1
              ...
              className="text-center text-9xl font-extrabold md:text-7xl sm:text-5xl"
            >
              Testimonials
            </h1>
            <p
              data-aos="fade-up"
              className=" text-lg text-center text-ct-grey-600 max-w-[766px] mx-auto my-4"
            >
